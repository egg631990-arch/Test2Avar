...
# 🔥 РАЗРЕШАЕМ CORS (для запросов с GitHub Pages)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # можно заменить на конкретный домен, но для теста *
...
async def on_startup():
    webhook_url = os.getenv("WEBHOOK_URL", "https://telegcas.onrender.com/webhook")
